    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <header className="text-center mb-10">
        ...
        <div className="flex justify-center gap-4 mt-4">
          <a href="https://github.com/arijitrishi" target="_blank" rel="noopener noreferrer" className="text-blue-600">GitHub</a>
          <a href="https://www.linkedin.com/in/arijit-ghosh-033257190" target="_blank" rel="noopener noreferrer" className="text-blue-600">LinkedIn</a>
          <a href="https://www.youtube.com/@tastivana" target="_blank" rel="noopener noreferrer" className="text-red-500">YouTube</a>
        </div>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <ul className="list-disc ml-5 text-gray-700">
            ...
            <li><a className="text-blue-600 underline" href="https://github.com/arijitrishi" target="_blank">View GitHub Projects</a></li>
          </ul>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          ...
          <ul className="list-disc ml-5 text-gray-700">
            <li>Runs a food vlog channel - <a className="text-red-500 underline" href="https://youtube.com/@tastivana" target="_blank">Tastivana</a></li>
        ...
        <div className="bg-white rounded-lg shadow p-4 md:col-span-2">
          ...
          <p className="mb-2 text-gray-700">
            Download my resume <a className="text-blue-600 underline" href="https://drive.google.com/file/d/1xGkcD29VBoYzTA5eCViuNhigYwi6r82X/view?usp=drive_link" download>here</a>.
          </p>
